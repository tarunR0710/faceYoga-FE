  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="text-[2rem] font-light text-ink mb-8">Refund Policy</h1>
        ...
        <div className="prose prose-gray max-w-none text-[15px] text-[#555] leading-relaxed space-y-6">
          ...
          {/* One policy, in one place. This page previously promised a 14-day
              ...
              apart again. */}
          <h2 className="text-[18px] font-normal text-ink mt-8 mb-4">
            {REFUND_POLICY.headline}
          </h2>
          <p>{REFUND_POLICY.detail}</p>

          <h2 id="rescheduling" className="text-[18px] font-normal text-ink mt-8 mb-4">Rescheduling</h2>
          <p>{REFUND_POLICY.reschedule}</p>

          <h2 className="text-[18px] font-normal text-ink mt-8 mb-4">In short</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong className="font-medium text-ink">Before your Face Mapping Session:</strong>{' '}
              full refund, no questions asked.
            </li>
            <li>
              <strong className="font-medium text-ink">After your session:</strong> the expert
            ...
            <li>
              <strong className="font-medium text-ink">If we cancel or miss your session:</strong>{' '}
              you choose a new slot or take a full refund.
            </li>
            <li>
              <strong className="font-medium text-ink">Duplicate payments:</strong> refunded in
              full — tell us and we will sort it.
            </li>
          </ul>

          <h2 className="text-[18px] font-normal text-ink mt-8 mb-4">How to request a refund</h2>
          <p>
            Email {SITE_CONFIG.email} from your registered email address with your order details.
            Refunds are processed within 5–7 business days to your original payment method.
          </p>

          <h2 className="text-[18px] font-normal text-ink mt-8 mb-4">Contact</h2>
